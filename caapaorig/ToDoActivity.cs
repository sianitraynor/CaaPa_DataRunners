...
namespace caapa
{
    ...
    public class ToDoActivity : Activity
    {
        ...
        private MobileServiceClient toDoItem;
        ...
        const string applicationURL = @"https://caapa.azure-mobile.net/";
        const string applicationKey = @"coHzRHuoqnHiolDACEHMunJRIeEJUH21";
